...
class ItensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create iten" do
    assert_difference("Iten.count") do
      post itens_url, params: { iten: { categoria: @iten.categoria, data_conclusão: @iten.data_conclusão, nome_evento: @iten.nome_evento, status: @iten.status } }
    end
  ...
  test "should update iten" do
    patch iten_url(@iten), params: { iten: { categoria: @iten.categoria, data_conclusão: @iten.data_conclusão, nome_evento: @iten.nome_evento, status: @iten.status } }
